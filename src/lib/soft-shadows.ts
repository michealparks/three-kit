...
if (kit__PCSS) {
  const pcss = `#define LIGHT_WORLD_SIZE ${kit__PCSS_SIZE}
  #define LIGHT_FRUSTUM_WIDTH ${kit__PCSS_FRUSTUM}
  #define LIGHT_SIZE_UV (LIGHT_WORLD_SIZE / LIGHT_FRUSTUM_WIDTH)
  #define NEAR_PLANE ${kit__PCSS_NEAR}
  #define NUM_SAMPLES ${kit__PCSS_SAMPLES}
  #define NUM_RINGS ${kit__PCSS_RINGS}
